...
public class OTPAuthURIBuilder {
    ...
    public OTPAuthURI build() {
        ...
        // NOT VALID FOR Vip ACCESS if (issuer != null && labelIssuerPrefix != null) { Preconditions.checkState(issuer.equals(labelIssuerPrefix), "The
        // 'issuer' and label issuer prefix values are different!"); }
